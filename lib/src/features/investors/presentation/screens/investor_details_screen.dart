                    ...
                    children: [
                      Row(
                        children: [
                          Hero(
                            tag: 'inv-${investor.id}',
                            child: CircleAvatar(radius: 20, backgroundColor: _gold.withOpacity(0.1), child: Text(investor.fullName[0], style: const TextStyle(color: _gold, fontWeight: FontWeight.bold))),
                          ),
                          const SizedBox(width: 12),
                          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            Text(investor.fullName, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16)),
                            Text(investor.email, style: TextStyle(color: Colors.white.withOpacity(0.5), fontSize: 11)),
                          ]),
                          const Spacer(),
                      ...
                      const Text('إجمالي القيمة المدارة', style: TextStyle(color: Colors.white70, fontSize: 12)),
