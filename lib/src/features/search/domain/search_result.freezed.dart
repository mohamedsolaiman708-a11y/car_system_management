...
mixin _$SearchResult {
  ...
  SearchEntityType get entityType => throw _privateConstructorUsedError;
...
class _$SearchResultImpl implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(id: $id, title: $title, subtitle: $subtitle, entityType: $entityType, metadata: $metadata)';
  }
...
abstract class _SearchResult implements SearchResult {
  const factory _SearchResult({
    ...
    final String? subtitle,
    required final SearchEntityType entityType,
