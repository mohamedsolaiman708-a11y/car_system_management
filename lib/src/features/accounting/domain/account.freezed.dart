...
abstract class $AccountCopyWith<$Res> {
  ...
  $Res call({
    ...
    String name,
    String type,
    @JsonKey(name: 'current_balance', defaultValue: 0.0) double currentBalance,
...
class _$AccountImpl implements _Account {
  ...
  @override
  String toString() {
    return 'Account(id: $id, code: $code, name: $name, type: $type, currentBalance: $currentBalance, isActive: $isActive)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, code, name, type, currentBalance, isActive);
...
abstract class _Account implements Account {
  ...
  String get name;
  @override
  String get type; // 'asset', 'liability', 'equity', 'revenue', 'expense'
  @override
  @JsonKey(name: 'current_balance', defaultValue: 0.0)
