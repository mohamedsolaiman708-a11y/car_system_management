...
mixin _$AppNotification {
  ...
  Map<String, dynamic>? get metadata =>
      throw _privateConstructorUsedError; // إضافة حقل البيانات الإضافية
...
class _$AppNotificationImpl implements _AppNotification {
  ...
  @override
  String toString() {
    return 'AppNotification(id: $id, profileId: $profileId, title: $title, content: $content, type: $type, metadata: $metadata, isRead: $isRead, createdAt: $createdAt)';
  }
...
abstract class _AppNotification implements AppNotification {
  ...
  String? get type;
  @override
  Map<String, dynamic>? get metadata; // إضافة حقل البيانات الإضافية
  @override
  @JsonKey(name: 'is_read')
  bool get isRead;
  @override
